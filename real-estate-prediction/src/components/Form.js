...
//       setPrediction(price);
//       setError("");  // ✅ Fix: Clears previous errors
//       saveModel();
//     } catch (error) {
...
//       console.log("📤 Sending Form Data to App:", formData);  // ✅ Debugging log
//       setPrediction(price, formData);  // ✅ Fix: Pass both price and formData
...
// import { useState } from "react";
// import { predictPrice, saveModel } from "../model/brainModel";  // ✅ Import from brainModel.js
// import "bootstrap/dist/css/bootstrap.min.css";
...
//           />
//           {formErrors.area && <p className="error-message text-danger">{formErrors.area}</p>}
//         </div>
...
//             onChange={handleChange}
//           />
//           {formErrors.bedrooms && <p className="error-message text-danger">{formErrors.bedrooms}</p>}
//         </div>
...
//             onChange={handleChange}
//           />
//           {formErrors.bathrooms && <p className="error-message text-danger">{formErrors.bathrooms}</p>}
//         </div>
...
//             onChange={handleChange}
//           />
//           {formErrors.age && <p className="error-message text-danger">{formErrors.age}</p>}
//         </div>

//         {/* Submit Button */}
//         <div className="mb-3">
//           <button className="btn btn-primary w-100" type="submit">Predict Price</button>
//         </div>
//       </form>
//     </div>
//   );
...
const Form = ({ setPrediction, setError }) => {
  ...
  const validateForm = () => {
    let errors = {};
    if (!formData.area || formData.area <= 0) errors.area = "❌ Please Enter a valid area!";
    if (!formData.bedrooms || formData.bedrooms <= 0) errors.bedrooms = "❌ Please Enter a valid number of bedrooms!";
    if (!formData.bathrooms || formData.bathrooms <= 0) errors.bathrooms = "❌ Please Enter a valid number of bathrooms!";
    if (!formData.age || formData.age < 0) errors.age = "❌ Please Enter a valid property age!";
    return errors;
  };
